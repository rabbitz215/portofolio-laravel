...
<body>
    ...
    <header class="bg-secondary bg-opacity-25 pt-5" id="home">
        <div class="container-fluid justify-content-center align-items-center d-flex flex-row pb-1">
            <h2 class="text-dark pt-3 ffam pe-3 hello">Hello... <br><span style="font-weight: bold;">Welcome To My Blog!!</span></h2>
            <img src="img/head.jpg" width="25%" alt="" class="rounded-circle mt-5 border border-2 border-secondary">
        </div>
    ...
    <section id="portofolio">
        <div class="container-fluid align-items-center d-flex flex-column pb-5 bg-secondary bg-opacity-25 pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card" style="width: 15rem;">
                        <img src="img/c1.png" height="240px" class="card-img-top" alt="">
                        <div class="card-body">
    ...
    <section id="about">
        ...
        <div class="container-fluid justify-content-center d-flex flex-row pb-4">
            <div class="row">
                <div class="col-md-4 text-end"><img src="img/dc.png" class="border border-2 border-secondary" width="150" alt=""></div>
                <div class="col-md-6">
                    <h4>Dreamcatcher</h4>
                    <div class="d-flex">
                    ...
                    <a href="/dreamcatcher">Baca Selengkapnya</a>
                    <hr>
                </div>
                <div class="col-md-2"></div>
                <div class="col-md-4 text-end"><img src="img/okrock.png" class="border border-2 border-secondary" width="150" alt=""></div>
                <div class="col-md-6">
                    <h4>One Ok Rock</h4>
                    <div class="d-flex">
                        <div class="tanggal">10-11-2021</div>
                    ...
                    <p>One Ok Rock (ditulis sebagai ONE OK ROCK) adalah band rock Jepang yang dibentuk tahun 2005 di Tokyo. Band ini beranggotakan Taka (vokalis), Toru (gitaris), Ryota (bassis),
                        dan Tomoya (drummer). Pada awalnya band ini memiliki lima anggota, namun gitaris Alex keluar pada tahun 2009.</p>
                    <a href="/oneokrock">Baca Selengkapnya</a>
                    <hr>
                </div>
                <div class="col-md-2"></div>
            </div>
